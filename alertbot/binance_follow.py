...
일봉 숏 진입 +25%. 이건 공용 기준(격리 3배)이고, 격리 배율이 높은 계정은 그 계정 주문에서만 청산선 안으로 당겨진다
(binance_trade.stop_for_leverage). 목표 지정가는 두지 않는다 — 두면 세 사양 모두 평균이 내려갔다. 관찰 단계에는 규칙과 현재 기준 ATR 만 싣는다.
