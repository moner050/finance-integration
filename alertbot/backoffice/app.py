...
KEY_FORMS = [
    ...
    {"name": "telegram", "title": "텔레그램 (내 live 알림)", "note": "받는 채팅에서 봇에게 먼저 /start 를 보내야 한다",
     ...
     # 어떤 알림이 여기로 오고 어떤 알림이 공용 채널로 가는지 — 감지·시황이 개인으로 안 온다는 문의가 반복돼서 화면에 적어 둔다
     "detail": [("여기로 오는 것", "내 계정 매매에 관한 것만 온다 — 📥 진입 체결 · 📤 종료(손절·목표가·보유 한도) · "
                                "⏸ 자금 부족으로 미체결 · ⏸ 보류(이미 보유 중·상한) · ⛔ 주문 실패 · ⚪ live 준비 · 📈 자정 성적표"),
                ("공용 채널로 가는 것", "🚀 급등 감지 · 💥 급락 감지 · 📊 시황 · 🔔 장 시작·마감 · 공용 가상 장부의 매매. "
                                    "시장 전체를 보는 알림이라 계정과 무관하다"),
                ("감지와 매매는 다르다", "급등 감지는 관찰이고, 매매로 이어질지는 나중에 정해진다 "
                                     "(급등 소진 숏은 48시간 안에 1시간봉이 EMA50 아래로 꺾일 때 진입). "
                                     "그 시점에 진입했거나 못 했다는 알림이 여기로 온다"),
                ("키를 지우면", "이 계정의 live 매매가 모두 꺼진다 — 알림 없는 실매매는 두지 않는다")]},
]
